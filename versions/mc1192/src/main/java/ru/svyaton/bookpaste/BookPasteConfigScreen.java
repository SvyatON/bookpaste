...
public final class BookPasteConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(centerX - 130, this.height / 2 + 46, centerButtonWidth, 20,
                Text.translatable("text.bookpaste.config.hotkey.reset"),
                button -> {
        ...
        this.addDrawableChild(new ButtonWidget(centerX + 4, this.height / 2 + 46, centerButtonWidth, 20,
                Text.translatable("text.bookpaste.config.hotkey.controls"),
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.bookpaste$drawCenteredText(matrices, Text.translatable("text.bookpaste.config.mode.label"), y, 0xA0A0A0);

        this.bookpaste$drawCenteredText(matrices, Text.translatable("text.bookpaste.config.hotkey.label"), this.height / 2 + 40, 0xA0A0A0);
